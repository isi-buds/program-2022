...
* Poisson regression is often used to mode count data
* Why count data are special?
...
## Poission Regression: The Overall Significance
```{r}
# Test for visual selectivity: Wald test
Wald.stat=poisson_fit$coefficients %*% 
  solve (summary(poisson_fit)$cov.unscaled) %*% 
